...
%A
filename = 'Valve_Results/Neumann/A0_pos2.png';
fieldname = 'A';
field1 = A_comsol;
field2 = A;
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,save);

filename = 'Valve_Results/Neumann/A1_pos2.png';
fieldname = 'A';
field1 = A_comsol;
field2 = A;
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,save);
%Bx
filename = 'Valve_Results/Neumann/Bx0_pos2.png';
fieldname = 'Bx';
field1 = Bx_comsol;
field2 = B(:,1);
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,save);

filename = 'Valve_Results/Neumann/Bx1_pos2.png';
fieldname = 'Bx';
field1 = Bx_comsol;
field2 = B(:,1);
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,save);
...
%By
filename = 'Valve_Results/Neumann/By0_pos2.png';
fieldname = 'By';
field1 = By_comsol;
field2 = B(:,2);
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,save);

filename = 'Valve_Results/Neumann/By1_pos2.png';
fieldname = 'By';
field1 = By_comsol;
field2 = B(:,2);
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,save);
