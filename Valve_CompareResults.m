...
%A
filename = 'Valve_Results/Neumann/A0.png';
fieldname = 'A';
field1 = A_comsol;
field2 = A;
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,1);

filename = 'Valve_Results/Neumann/A1.png';
fieldname = 'A';
field1 = A_comsol;
field2 = A;
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,1);
%Bx
filename = 'Valve_Results/Neumann/Bx0.png';
fieldname = 'Bx';
field1 = Bx_comsol;
field2 = B(:,1);
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,1);

filename = 'Valve_Results/Neumann/Bx1.png';
fieldname = 'Bx';
field1 = Bx_comsol;
field2 = B(:,1);
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,1);
...
%By
filename = 'Valve_Results/Neumann/By0.png';
fieldname = 'By';
field1 = By_comsol;
field2 = B(:,2);
SubPlotData(x,y,elems2nodes,field1,field2,params,[],filename,fieldname,1);

filename = 'Valve_Results/Neumann/By1.png';
fieldname = 'By';
field1 = By_comsol;
field2 = B(:,2);
SubPlotData(x,y,elems2nodes,field1,field2,params,zoom,filename,fieldname,1);
