...
filename = '../Valve_Data/Valve_axialsym.mph';
model = mphopen(filename);

A_comsol  = mphinterp(model, 'mf.Aphi', 'coord', mesh.nodes2coord', 'solnum', 1)';
Bx_comsol = mphinterp(model, 'mf.Br', 'coord', mesh.nodes2coord', 'solnum', 1)';
By_comsol = mphinterp(model, 'mf.Bz', 'coord', mesh.nodes2coord', 'solnum', 1)';
